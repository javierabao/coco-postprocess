...
res = data_archive.get_first("""
            + repr(substrs)
            + """)  # get first match for each substr
...
def main(arguments):
    ...
    recent_data_path = os.path.abspath(join_path(os.path.dirname(__file__), "../../code-experiments/build/python/exdata"))
    recent_data_path = False
    ...
    print("*** testing module cocopp {0} ***".format("(all ~ 30 minutes)" if run_all_tests else "(~ 5 minutes)"))
    t0 = time.time()
    ...
    if run_all_tests:
        ...
        t0 = time.time()
        with InfolderGoneWithTheWind():
            result = os.system(python + command + data_archive_get(["SMAC-BBOB_hutter_noiseless.tgz", "lmm-CMA-ES_auger_noiseless.tgz"]))
        ...
        with InfolderGoneWithTheWind():
            result = os.system(
                python + command + " --include-single " + data_archive_get(["DE-PSO_garcia-nieto_noiseless.tgz", "VNS_garcia-martinez_noiseless.tgz"])
            )
        ...
        t0 = time.time()
        with InfolderGoneWithTheWind():
            result = os.system(python + command + " --expensive " + data_archive_get("VNS_garcia-martinez_noiseless.tgz"))
        ...
        t0 = time.time()
        with InfolderGoneWithTheWind():
            result = os.system(python + command + data_archive_get(["RANDOMSEARCH-4_Auger_bbob-biobj.tgz", "RANDOMSEARCH-100_Auger_bbob-biobj.tgz"]))
        ...
        with InfolderGoneWithTheWind():
            result = os.system(
                ...
                + command
                + data_archive_get(
                    ["NSGA-II-MATLAB_Auger_bbob-biobj.tgz", "RANDOMSEARCH-4_Auger_bbob-biobj.tgz", "RANDOMSEARCH-100_Auger_bbob-biobj.tgz"]
                )
            )
        ...
        t0 = time.time()
        with InfolderGoneWithTheWind():
            result = os.system(python + command + data_archive_get(["MCS_huyer_noisy.tgz", "BFGS_ros_noisy.tgz"]))
        ...
        if recent_data_path:  # requires local data to have been generated
            with InfolderGoneWithTheWind():
                t0 = time.time()
                result = os.system(python + command + join_path(recent_data_path, "RS-bb"))
            ...
            with InfolderGoneWithTheWind():
                t0 = time.time()
                result = os.system(python + command + join_path(recent_data_path, "RS-bi"))
        ...
        with InfolderGoneWithTheWind():
            t0 = time.time()
            result = os.system(python + command + data_archive_get("test/RS-4.zip"))
        ...
        if recent_data_path:  # requires local data to have been generated
            with InfolderGoneWithTheWind():
                t0 = time.time()
                result = os.system(python + command + join_path(recent_data_path, "RS-la"))
            ...
            with InfolderGoneWithTheWind():
                t0 = time.time()
                result = os.system(python + command + join_path(recent_data_path, "RS-mi"))
            ...
            with InfolderGoneWithTheWind():
                t0 = time.time()
                result = os.system(python + command + join_path(recent_data_path, "RS-bi-mi"))
        ...
        with InfolderGoneWithTheWind():
            t0 = time.time()
            result = os.system(python + command + "bbob/2009/BFGS! bbob-largescale/2019/LBFGS!")
