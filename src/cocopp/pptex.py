...
latex_color_map_old = {"g": "green!45!black", "r": "red", "c": "cyan", "m": "magenta", "y": "yellow", "k": "black", "b": "blue"}
latex_color_map = {
...
class WrongInputSizeError(Error):
    ...
    def __str__(self):
        message = "The size of %s is %s. One dimension must be of length %s!" % (self.arrName, str(self.arrSize), str(self.reqSize))
        return repr(message)
