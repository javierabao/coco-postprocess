...
def validate_html():
    ...
    texFile = os.path.join(os.path.dirname(os.path.realpath(__file__)), comparing_file_name + ".tex")

    prepare_html(texFile)

    original_html = os.path.join(os.path.dirname(os.path.realpath(__file__)), original_file_name + ".html")
    generated_html = os.path.join(os.path.dirname(os.path.realpath(__file__)), comparing_file_name + ".html")
